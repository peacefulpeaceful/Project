...
public class ParcelService implements IParcelService {
    ...
    public ParcelService(ParcelRepository repo, ClientRepository clientRepo, IBlacklistService blacklistService) {
        this.repo = repo;
    ...
    public Parcel createParcel(double weight, ParcelCategory category, Client sender, Client recipient) {
        validationService.validateWeight(weight);
        validationService.validateCategory(category);
        validationService.validateClient(sender);
        validationService.validateClient(recipient);
